...
\subsection{Models}
We will implement three different models, to test our simulations under multiple circumstances. 
...
\subsubsection{Final model - Entire solar system}
Finally, we include all eight planets in the solar system, as well as Pluto for historical reasons. We also include all interactions between the planets. We use the Velocity-Verlet method to solve this numerically.
\subsection{A brief overview of our code}
In this section 
...
\section{Results}
\section{Discussion}
\subsection{Discussin the perihelion precession of mercury}
