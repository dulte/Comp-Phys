...
\linebreak
The final point is slightly more surprising. Given that we start in a uniform state, we would expect the mean absolute magnetic moment per spin 
\section{Conclusion}
\end{document}

%REMEMBER TO COMPARE RESULTS AT POINT