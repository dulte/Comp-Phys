    ...
    def getInfo(self,ID,startdate,enddate):
        ...
        with open('temp.txt', 'r') as fp:
            for line in fp:
                ...
                #This loop looks for the mass. Due to inconsistant formating from NASA, this loop is fairly complicated
...
#The info is always retrieved from the startdate, the end date is only given because for the telnet site to work
start = "1977-Oct-18"
end = "1977-Oct-19"
